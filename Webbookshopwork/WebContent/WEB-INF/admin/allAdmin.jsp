    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="findAdminByPoint.to" method="post">
        ...
        <div class="result-wrap">
           <form action="deleteApartAdmin.to">
                <div class="result-title">
                
                    <div class="result-list">
                    
                        <a href="addAdmin.to"><i class="icon-font"></i>新增管理员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>${user.email}</td>
                            <td>
                                <a class="link-update" href="findAdmin.to?id=${user.id}">查看</a>
                                <a class="link-del" href="deleteAdmin.to?id=${user.id}">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                     ...
                     <div class="list-page"> 
                    	...
                    	<br/>
                    	<a href="seeAllAdmin.to?pages=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage != 1}">
							<a href="seeAllAdmin.to?pages=${page.dpage-1 }">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${(page.dpage != page.totalPage) && (page.totalPage != 0)}">
							<a href="seeAllAdmin.to?pages=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="seeAllAdmin.to?pages=${page.totalPage}">尾页</a>
                    </div>
                </div>
