...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.to">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">商品管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="findBookByKey.to" >
                    <table class="search-tab">
                        <tr>
                        	<th width="120px"></th>
                         <!--<th width="120">选择分类:</th> 
                            <td>
                                <select name="booktype" id="" name="booktype">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="deletePartBook.to">
                <div class="result-title">
                    <div class="result-list">
                        <a href="addBook.to"><i class="icon-font"></i>新增书籍</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                        	<td class="tc"><input type="checkbox" name="ifdelete" id="ifdelete" value="${book.id}" /></td>
                            <td>${book.id}</td>
                            <td>${book.bookName}</td>
                            <td>${book.author}</td>
                            <td>${book.publish}</td>
                            ...
                            <td>${book.price}</td>
                            <td>
                                <a class="link-update" href="findBookById.to?id=${book.id}">查看</a>
                                <a class="link-del" href="deleteBookById.to?id=${book.id}">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                    ...
                    <div class="list-page"> 
                    	...
                    	<br/>
                    	<a href="seeAllBook.to?pages=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage != 1}">
							<a href="seeAllBook.to?pages=${page.dpage-1 }">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${(page.dpage != page.totalPage) && (page.totalPage != 0)}">
							<a href="seeAllBook.to?pages=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="seeAllBook.to?pages=${page.totalPage}">尾页</a>
                    </div>
                </div>
