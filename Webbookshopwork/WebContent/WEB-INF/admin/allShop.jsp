...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.to">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">订单管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="findShopByPoint.to" method="post">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="deletepartShop.to">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                        	<td class="tc"><input type="checkbox" name="ifdelete" id="ifdelete" value="${shop.id}" /></td>
                            <td>${shop.id}</td>
                            <td>${shop.order.book.bookName}</td>
                            <td>${shop.user.username}</td>
                            <td>${shop.order.quentity}</td>
                            <td>${shop.date}</td>
                            <td>${shop.state}</td>
                            <td>
                                <a class="link-update" href="findShop.to?id=${shop.id}">查看</a>
                                <a class="link-del" href="deleteShop.to?id=${shop.id}">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                     ...
                     <div>
                    	...
                    	<br/>
                    	<a href="getAllType.to?pages=1">首页</a>&nbsp;&nbsp;&nbsp;
						<c:if test="${page.dpage != 1}">
							<a href="seeAllShop.to?pages=${page.dpage-1 }">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${(page.dpage != page.totalPage) && (page.totalPage != 0)}">
							<a href="seeAllShop.to?pages=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="seeAllShop.to?pages=${page.totalPage}">尾页</a>
                    </div>
                </div>
