...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.to">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">类别管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="findTypeByPoint.to" method="post">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="deletepartType.to">
                <div class="result-title">
                    <div class="result-list">
                        <a href="addType.to"><i class="icon-font"></i>新增类别</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                        	<td class="tc"><input type="checkbox" name="ifdelete" id="ifdelete" value="${type.id}"/></td>
                            <td>${type.id}</td>
                            <td>${type.type}</td>
                            <td>
                                <a class="link-update" href="findTypeById.to?id=${type.id}">查看</a>
                                <a class="link-del" href="deleteType.to?id=${type.id}">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                    ...
                    <div>
						...
						<c:if test="${page.dpage != 1}">
							<a href="getAllType.to?pages=${page.dpage-1 }">上一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<c:if test="${(page.dpage != page.totalPage) && (page.totalPage != 0)}">
							<a href="getAllType.to?pages=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
						</c:if>
						<a href="getAllType.to?pages=${page.totalPage}">尾页</a>
                    </div>
                </div>
