    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="updateBook.to" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tr>
                            ...
                            <td>
                            	...
                            	<c:forEach items="${typelist}" var="a">
                                		<c:forEach items="${book.typeSet}" var="type"> 
                                				<c:if test="${type.type == a.type}">
                                				<input type="checkbox" name="type" value="${type.id}" checked="checked" />${type.type}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                				</c:if>
                                		</c:forEach>
                                </c:forEach>
                                <c:forEach items="${typelist1}" var="b">
                                		<input type="checkbox" name="type" value="${b.id}"  />${b.type}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </c:forEach>
                            </td>
                            </tr>
                             <tr>
                            ...
                            <td>
                            	<c:forEach items="${marketlist}" var="a">
                                		<c:forEach items="${book.markSet}" var="mark"> 
                                				<c:if test="${mark.type == a.type}">
                                				<input type="checkbox" name="mark" value="${mark.id}" checked="checked" />${mark.type}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                				</c:if>
                                		</c:forEach>
                                </c:forEach>
                                <c:forEach items="${marketlist1}" var="b">
                                		<input type="checkbox" name="mark" value="${b.id}"  />${b.type}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </c:forEach>                            </td>
                        </tr>
                            <tr>
