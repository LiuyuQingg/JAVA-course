	...
	<input type="hidden" value="${msg}" id="msg" />
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="updateShop.to" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                            	<img src=".././${shop.order.book.imgUrl}" style="width:200px;height:200px;">
                            </td>
                        </tr>
                        <tr>
                            <th width="120"><i class="require-red">*</i>书名：</th>
                            <td>
                                <input style="width: 500px;" readonly="readonly" type="text" name="bookName"  value="${shop.order.book.bookName}"/>
                            </td>
                        </tr>
                            <tr>
                                <th width="120"><i class="require-red">*</i>用户名：</th>
                            <td>
                                <input style="width: 500px;" readonly="readonly"  type="text" name="price" value="${shop.user.username}" />
                            </td>
                            </tr>
                            <tr>
                                <th width="120"><i class="require-red">*</i>数量：</th>
                            <td>
                                <input style="width: 500px;" readonly="readonly"  type="text" name="price" value="${shop.order.quentity}" />
                            </td>
                            </tr>
                            <tr>
                                <th width="120"><i class="require-red">*</i>日期：</th>
                            <td>
                            <input style="width: 500px;" readonly="readonly"  type="text" name="date" value="${shop.date}" />
                            </td>
                            </tr>
                            <tr>
                                <th width="120"><i class="require-red">*</i>状态：</th>
                            <td>
                               <input style="width: 500px;" readonly="readonly"  type="text" name="state" value="${shop.state}" />
                            </td>
                            </tr>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" value="发货" type="submit">
