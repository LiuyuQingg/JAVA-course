    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="updateAdmin.to"  id="myform" name="myform"  method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>用户头像：</th>
                            <td>
                            	<img src=".././${admin.imgUrl}" alt="用户头像" style="width: 100px;height: 100px" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="id" size="50" value="${admin.id}" type="text" style="width: 300px;" readonly = "readonly">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>用户名：</th>
                                <td><input class="common-text" name="username" size="50" value="${admin.username}" type="text" style="width: 300px;"readonly = "readonly"></td>
                            </tr>
                            <!-- <tr>
                            	<th><i class="require-red">*</i>密码：</th>
                                <td><input class="common-text" name="password" size="50" value="${admin.password}" type="text" style="width: 300px;"readonly = "readonly"></td>
                            </tr> -->
                            <tr>
                                <th><i class="require-red">*</i>地址：</th>
                                <td><input class="common-text" name="address" size="50" value="${admin.address}" type="text" style="width: 300px;"readonly = "readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><!--<textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea>  -->
                                	  <input class="common-text" name="phone" size="50" value="${admin.phone}" type="text" style="width: 300px;"readonly = "readonly">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>e-mail：</th>
                                <td><input class="common-text" name="email" size="50" value="${admin.email}" type="text" style="width: 300px;"readonly = "readonly"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
