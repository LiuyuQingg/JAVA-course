		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li><a href="/Webbookshopwork/book/recommend.do" class="active">亲爱的</a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">图书<b class="caret"></b></a>
							<ul class="dropdown-menu multi-column columns-4">
								<div class="row">
									<div class="col-sm-3">
										<h4><a href="/Webbookshopwork/book/booklist.do"><font color="#FF4500" style="font-weight=bolder">全部</font></a></h4>
									...
									<div class="col-sm-3">
										<h4>按标签</h4>
										<ul class="multi-column-dropdown">
											<li><a class="list" href="/Webbookshopwork/book/seeMarkBook.do?type=推荐">推荐</a></li>
											<li><a class="list" href="/Webbookshopwork/book/seeMarkBook.do?type=上新">上新</a></li>
											<li><a class="list" href="/Webbookshopwork/book/seeMarkBook.do?type=主推">主推</a></li>
					   ...
					   <li class="dropdown grid">
							<a href="/Webbookshopwork/book/seeNewBook.do" class="dropdown-toggle list1" data-toggle="dropdown">上新<b class="caret"></b></a>
							<ul class="dropdown-menu multi-column columns-4">
								<div class="row">
									<div class="col-sm-3">
										<h4><a href="/Webbookshopwork/book/newbook.do"><font color="#FF4500" style="font-weight=bolder">全部</font></a></h4>
										<!--  <ul class="multi-column-dropdown">
											<li><a class="list" href="products.html">Friend</a></li>
											<li><a class="list" href="products.html">Lover</a></li>
											<li><a class="list" href="products.html">Sister</a></li>
			...
			<div class="header-info">
				<div class="header-right search-box">
					...
					<div class="search">
						<form class="navbar-form" action="/Webbookshopwork/book/foundBook.do">
				...
				<div class="header-right cart">
					<a href="/Webbookshopwork/book/seeBookChat.do?id=${user1.id}"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>
					<div class="cart-box">
						<h4><!-- <a href="/Webbookshopwork/book/seeBookChat.do?id=${user1.id}">
							<span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>) 
						</a> --></h4>
						<p><a href="deleteAllChat.do" class="simpleCart_empty">清空购物车</a></p></p>
			...
			<div class="register">
				<form action="updateUser.do" method="post" enctype="multipart/form-data"> 
					<div class="register-top-grid">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						<img src="../${user.imgUrl}" alt="用户头像" style="align:center; width:150px;height:150px" />
