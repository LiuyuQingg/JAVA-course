...
<script type="text/javascript"> 
	...
	<div class="contact">
		<div class="container">
			...
			<div class="map">	
			<h4>送货清单</h4>
			<div style=" width: 1100px;height: 340px;border-color: #CD3700;border-style: solid;border-width: 1px;" >
				<br/><table border="0" align="center" bordercolor="#CD3700">
					<tr>
						<td rowspan="6" width="310px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr>
						<td>数量：<input type="text" id="quentity" value="${order.quentity}"  onblur="quonblur()"/></td>
					</tr>
					<tr>
						<td colspan="2">送货地址：<input id="address" type="text" name="address" value="${order.user.address}" style="width: 500px;" />  </td>
					</tr>
				...
				总价:   <input type="text" readonly="readonly" id="total" style="width: 100px;" />
				<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<button class="btn1"><a id="buy" onclick="clicka()">立即付款</a></button>
				</div>
