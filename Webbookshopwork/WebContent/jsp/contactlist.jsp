...
<script type="text/javascript"> 
	...
	<div class="contact">
		<div class="container">
			...
			<form action="partShopping.do">
			<div align="center"><h3 style="align-self: center;">送货地址：<input style="width:700px;" type="text" name="address" value="${user.address}" /></h3></div>
			...
			<div style="margin:20px; width: 1100px;height: 340px;border-color: #CD3700;border-style: solid;border-width: 1px;" >
				<br/><table border="0" align="center" bordercolor="#CD3700">
					...
					<tr>
						<td>数量：<input type="text" name="quentity" id="quentity" value="${order.quentity}"  onblur="quonblur(this)"/></td>
					</tr>
					<tr>
					...
					<!-- <tr>
						<td>总价： ${order.quentity * order.book.price}</td>
						<!-- <td>数量：${order.quentity}</td> 
				...
				<!--  总计:   <input type="text" readonly="readonly" id="total" style="width: 100px;" />
				<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
				<input type="submit" value="立即付款" class="btn1"/>
				</form>
				</div>
