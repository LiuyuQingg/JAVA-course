...
<body>
		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<font color="white" style="font-weight: bolder;">欢迎&nbsp;&nbsp;&nbsp;&nbsp;${user1.username}</font>
					<!--/.navbar-collapse-->
				</div>
				<!--//navbar-header-->
				...
				<div class="header-right login">
					...
					<div id="loginBox">                
						<form id="loginForm" action="/Webbookshopwork/user/login.do">
							...
							<p>New User ? <a class="sign" href="regist.do">注册</a> <span><a href="/Webbookshopwork/findpassword.jsp">忘记密码?</a></span></p>
						</form>
					</div>
				</div>
	...
	<div class="banner" >
		<div class="container" >
			<h2 class="hdng">最好的 <span>书</span> 给最亲爱的你</h2>
			<p>Give the best books to the dearest you</p><br/>
			<a href="booklist.do">SHOP NOW</a>
			<div class="banner-text">	
				<br/><br/><br/><br/>
				<img src="../images/touyingzideren.jpg" alt="偷影子的人" width="50px" height="250px"/>	
			</div>
		</div>
	</div>			
	<!--//banner-->
	...
	<div class="gallery">
		<div class="container">
			...
			<c:forEach items="${list}"  var="b">
				<div class="col-md-8 gallery-grid glry-one" style="width:550px;">
					<a href="seeSingleBook.do?id=${b.id}"><img src="../${b.imgUrl}" class="img-responsive" alt="" style="width:500px;height:300px;"/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="seeSingleBook.do?id=${b.id}">SHOP NOW</a>
							<div class="clearfix"> </div>
						</div>
					</a>
					<div class="galy-info">
						...
						<div class="galry">
							<div class="prices">
								<h5 class="item_price">￥ ${b.price}</h5>
							</div>
							<div class="rating">
								<span>☆</span>
								<span>☆</span>
				...
				<div class="col-md-3 gallery-grid " weight="150" height="250">
					<a href="seeSingleBook.do?id=${book.id}"><img src="../${book.imgUrl}" class="img-responsive" alt=""  style="height:300px"/>
						<div class="gallery-info">
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
							<a class="shop" href="seeSingleBook.do?id=${book.id}">SHOP NOW</a>
							<div class="clearfix"> </div>
						</div>
					</a>
					<div class="galy-info">
	...
	<div class="subscribe">
		 <div class="container">
			 ...
			 <form action="http://www.baidu.com" >
				 <input type="text" name="tag" class="text" value="输入你想搜索的关键字" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '输入你要搜索的关键字';}">
