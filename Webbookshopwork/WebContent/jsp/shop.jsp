	...
	<div class="cart-items">
		<div class="container">
			...
			<div class="cart-header">
				<a href="deleteShop.do?id=${shop.id}&state=${shop.state}"><div class="close1"> </div></a>
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						 <img src="../${shop.order.book.imgUrl}" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
						<h3><a href="#"> ${shop.order.book.bookName} </a><span>数量：${shop.order.quentity}</span></h3>
						<ul class="qty">
							<li><p>${shop.order.book.author}</p></li>
							<li><p>${shop.order.book.publish}</p></li>
						</ul><br/>
						<p>${shop.state}</p>
						<div class="delivery">
						<div style="float: inherit;"><a href="clearShop.do?id=${shop.id}&state=${shop.state}">取消订单</a></div><br/>
							<p>价格：￥ ${shop.order.book.price}</p>
